...
\usepackage{hyperref}
\hypersetup{
            pdftitle={Sample R Markdown Presentation},
...
\title{Sample R Markdown Presentation}
\providecommand{\subtitle}[1]{}
\subtitle{PSY 525}
\author{Rick Gilmore}
\date{2020-02-20 10:50:59}
...
\includegraphics{sample-presentation-beamer_files/figure-beamer/pressure-1.pdf}
...
\includegraphics[width=15.5in,height=500px]{img/sleic}
