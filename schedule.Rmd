...
1. Open a PsychoPy demo program and save it with a new name. 
Add additional documentation to the demo program that explains what's happening. Change one or more parameters to make the program do something slightly different, and explain what parameters you changed.
