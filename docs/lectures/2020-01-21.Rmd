...
- Better, more systematic documentation of theoretical commitments, unstated assumptions
...
```{r, fig.cap="[[@collaboration_estimating_2015]](http://doi.org/10.1126/science.aac4716)"}
...
##  Differences across scientific domains [[@goodman_what_2016]](http://doi.org/10.1126/scitranslmed.aaf5027)
